...
![invoice](https://repo.x-cmd.io/invoice.svg?lang=zh)
...
- **上游仓库**: <https://github.com/maaslalani/invoice>
- **许可证**: MIT

## 发布

- **最新版本**: `v0.1.0` (2023-06-29)
- **最近提交**: 2023-11-30
- **Release 含资产**: 9 个

## 流行度

- **Star**: 2,193 · **Fork**: 114 · **开放 issue**: 24 · **贡献者**: 7

## 累计统计

- **发布数**: 1 · **已合并 PR**: 13 · **开放 PR**: 6 · **已关闭 issue**: 5 · **开放 issue**: 19 · **提交数**: 45
...
在 [repology.org](https://repology.org/project/invoice) 上共有 **14** 个发行版报告此项目。**12** 个 ✅ 已是最新上游版本，**0** 个 ⚠️ 使用旧版本。
...
invoice 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `invoice` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/invoice.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260912.yml` · 2026-09-12T04:25:15Z._
